                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu float-right" aria-labelledby="navbarDropdownMenuLink">
                                <c:choose>
                                    <c:when test="${language eq 'es'}">
                                        <a class="dropdown-item" href="${URL_ADD_EDIT_CONFIG}?language=eu">Euskara</a>
                                        <a class="dropdown-item active" href="#">Español</a>
                                        <a class="dropdown-item" href="${URL_ADD_EDIT_CONFIG}?language=en">English</a>
                                    </c:when>
                                    <c:when test="${language eq 'eu'}">
                                        <a class="dropdown-item active" href="#">Euskara</a>
                                        <a class="dropdown-item" href="${URL_ADD_EDIT_CONFIG}?language=es">Español</a>
                                        <a class="dropdown-item" href="${URL_ADD_EDIT_CONFIG}?language=en">English</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="dropdown-item" href="${URL_ADD_EDIT_CONFIG}?language=eu">Euskara</a>
